...
class TBSnackbarManager {
    ...
    public void show(int duration, Callback callback) {
        synchronized (mLock) {
            if (isCurrentSnackbarLocked(callback)) {
                ...
                // If this is the TBSnackbar currently being shown, call re-schedule it's
                // timeout
    ...
    /**
     * Should be called when a TBSnackbar is no longer displayed. This is after any exit
     * animation has finished.
     */
    public void onDismissed(Callback callback) {
        synchronized (mLock) {
            if (isCurrentSnackbarLocked(callback)) {
                // If the callback is from a TBSnackbar currently show, remove it and show a new one
                mCurrentSnackbar = null;
    ...
    /**
     * Should be called when a TBSnackbar is being shown. This is after any entrance animation has
     * finished.
     */
    ...
    private void showNextSnackbarLocked() {
        if (mNextSnackbar != null) {
            ...
            if (callback != null) {
                ...
                // The callback doesn't exist any more, clear out the TBSnackbar
                mCurrentSnackbar = null;
            }
        }
    }
